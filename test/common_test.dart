...
void main() {
  group('test get_distance of coordinates', () {
    test(
        ...
        () {
      const LatLng start = LatLng(52.421327, 10.623056);
      const LatLng end = LatLng(52.42748887594039, 10.623379056822062);
      final double dist = DistUtils.haversineDistance(
        start.latitude,
        start.longitude,
        end.latitude,
        end.longitude,
    ...
    test(
        ...
        () {
      const LatLng start = LatLng(52.45175365359977, 10.679139941065786);
      const LatLng end = LatLng(51.7578902763405, 10.74257578002594);
      final double dist = DistUtils.haversineDistance(
        start.latitude,
        start.longitude,
        end.latitude,
